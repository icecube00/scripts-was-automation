...
#   when    who ver  what
# --------  --- ---- ----------
# 11/09/07  rag 04.  Fix - Allow name to have periods
...
#---------------------------------------------------------------------
def displayOperations( bean ) :
  'displayOperations( bean ) - Display signature details of specified MBean operations.'
  sortByFunName = lambda x, y: cmp( x[ 1 ].lower(), y[ 1 ].lower() )
  data = []
  for line in Help.operations( bean ).splitlines()[ 1:-1 ] :
